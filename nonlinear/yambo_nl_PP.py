...
# parse command line
#
parser = argparse.ArgumentParser(prog='yambo_nl_PP',description='Analyse ypp output to extract nonlinear refractive index and two-photon absorption',epilog="Copyright C. Attaccalite and M. Grüning 2017")
